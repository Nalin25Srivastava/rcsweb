    ...
    const loginWithGoogle = useGoogleLogin({
        onSuccess: async (response) => {
            if (response.access_token) {
                console.log('Google Access Token received, authenticating with backend...');
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex flex-col items-center gap-4 mt-4 w-full">
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-100 hover:border-emerald-500 hover:bg-emerald-50/30 text-slate-700 font-bold py-4 px-6 rounded-xl transition-all active:scale-95 shadow-sm group"
                            >
