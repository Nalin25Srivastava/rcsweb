                        ...
                        <div className="flex justify-center mt-4 min-h-[50px]">
                            <GoogleLogin
                                ...
                                onSuccess={async (credentialResponse) => {
                                    // This will only be called if redirect succeeds and library handles it
                                    // In redirect mode, the library often handles this on reload
                                    const action = await dispatch(googleLogin({ 
                                ...
                                onError={(error) => {
                                    console.error('Google Login Failed:', error);
                                    alert('Google Login failed. If you see "Access Blocked: Invalid Request", you MUST add your current URL to Authorized JavaScript Origins in Google Cloud Console.');
                                }}
                                theme="filled_black"
                                shape="pill"
                            />
