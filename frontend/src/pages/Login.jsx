...
const Login = () => {
    ...
    const loginWithGoogle = useGoogleLogin({
        onSuccess: (tokenResponse) => {
            console.log('Google Login Success (Access Token):', tokenResponse);
        ...
        onError: (error) => {
            ...
            // Check for common issues like blocked popups or origin mismatch
            if (error.error === 'idpiframe_initialization_failed') {
                console.error('Google Auth initialization failed. This usually means the origin is not whitelisted in GCP.');
            }
        }
    });
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-start py-20 bg-slate-50 dark:bg-slate-950 relative overflow-x-hidden transition-colors duration-300">
            ...
            >
                ...
                {/* Right Side: Form */}
                <div className="md:w-7/12 p-8 md:p-14 lg:p-16 flex flex-col">
                    <div className="mb-10 text-center md:text-left">
                        <h2 className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tracking-tight">Welcome Back</h2>
                        <p className="text-slate-500 dark:text-slate-400 font-bold mt-2">Log in to view your dashboard</p>
                    </div>
                        ...
                        <div className="flex flex-col items-center gap-4 mt-6 w-full">
                            ...
                            >
                                <svg className="w-6 h-6" viewBox="0 0 24 24">
                                    ...
                                    <path fill="#FBBC05" d="M5.84 14.09c-.22-.67-.35-1.39-.35-2.14s.13-1.47.35-2.14V7.01H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.99l3.66-2.9z"/>
                                    <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.01l3.66 2.9c.87-2.6 3.3-4.53 6.16-4.53z"/>
                                </svg>
