            ...
            <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="mt-8 space-y-4">
                            {[
                                ...
                                <motion.div 
                                    ...
                                    className="flex items-center gap-3 text-slate-800 font-bold bg-white p-4 rounded-xl shadow-sm border border-slate-100"
                                >
                    ...
                    >
                        ...
                        <div className="bg-white p-4 rounded-3xl shadow-2xl relative border border-white">
                            <img 
